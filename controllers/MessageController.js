var GalleryModel = require('../models/Message');
...
module.exports = {
    ...
    update: function (req, res) {
        ...
        GalleryModel.findOne({ _id: id }, function (err, Patient) {
            ...
            Patient.fromid = req.body.fromid ? req.body.fromid : Patient.fromid;
            Patient.toid = req.body.toid ? req.body.toid : Patient.toid;
            Patient.msg = req.body.msg ? req.body.msg : Patient.msg;
            Patient.datetime = req.body.datetime ? req.body.datetime : Patient.datetime;
            Patient.read = req.body.read ? req.body.read : Patient.read;
            Patient.save(function (err, Patient) {
                if (err) {
                    return res.status(500).json({
